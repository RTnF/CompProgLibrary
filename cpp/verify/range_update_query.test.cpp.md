...
data:
  ...
  code: "#define PROBLEM                                                         \
    ...
    \  cin >> n >> q;\n  vector<RangeSetRangeSum<int>::RangeSum> a(n, {(1ll << 31)\
  ...
  verifiedWith: []
documentation_of: cpp/verify/range_update_query.test.cpp
layout: document
redirect_from:
- /verify/cpp/verify/range_update_query.test.cpp
- /verify/cpp/verify/range_update_query.test.cpp.html
