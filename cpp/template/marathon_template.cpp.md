...
data:
  ...
  code: "#include <bits/stdc++.h>\nusing namespace std;\nusing ll = int64_t;\nusing\
    ...
    \ i = 0, i##_end = (n); i < i##_end; i++)\n#define repb(i, n) for (int i = (n)\
    \ - 1; i >= 0; i--)\n#define repr(i, a, b) for (int i = (a), i##_end = (b); i\
    \ < i##_end; i++)\n#define reprb(i, a, b) for (int i = (b) - 1, i##_end = (a);\
    ...
    \ T(0));\n}\nnamespace in {\ntemplate <typename T> bool print(const T &a) {\n\
    \  cout << a;\n  return true;\n}\ntemplate <typename T> bool print(const vector<T>\
    \ &vec) {\n  for (auto &a : vec) {\n    cout << a;\n    if (&a != &vec.back())\n\
